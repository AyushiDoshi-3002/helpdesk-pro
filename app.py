...
h1, h2, h3, .stTitle { font-family: 'Syne', sans-serif !important; }
...
# Import from modules folder (not pages — avoid Streamlit conflict)
from modules import employee_portal, admin_panel, setup_page
...
def main():
    with st.sidebar:
        ...
        st.markdown("---")
        st.markdown(
            "<small style='opacity:0.6'>Powered by Supabase</small>",
            unsafe_allow_html=True
        )
