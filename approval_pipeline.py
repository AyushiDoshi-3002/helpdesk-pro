...
# ── Main Page with Split Layout (This is the only part changed) ───────────────
def page_approval_pipeline():
    ...
    with right_col:
        ...
        st.markdown("Senior roles (Manager+) get instant access. Others need approval.")
    ...
    # Approver Review Section (kept original)
    st.markdown("---")
    ...
    with role_tabs[0]: st.info("Team Lead view")
